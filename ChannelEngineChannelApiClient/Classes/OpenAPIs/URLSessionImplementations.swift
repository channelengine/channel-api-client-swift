...
open class URLSessionRequestBuilder<T>: RequestBuilder<T> {
    ...
    override open func execute(_ apiResponseQueue: DispatchQueue = ChannelEngineChannelApiClientAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) {
        ...
        case is URL.Type:
            do {
                ...
                if let headerFileName = getFileName(fromContentDisposition: httpResponse.allHeaderFields["Content-Disposition"] as? String) {
                    ...
                    requestPath = requestPath.appending("/tmp.ChannelEngineChannelApiClient.\(UUID().uuidString)")
                }
    ...
    open func buildHeaders() -> [String: String] {
        ...
        for (key, value) in ChannelEngineChannelApiClientAPI.customHeaders {
            httpHeaders[key] = value
        }
        return httpHeaders
    }
