...
public struct CollectionOfChannelShipmentResponse: Codable, Hashable {
    ...
    public init(content: [ChannelShipmentResponse]? = nil, count: Int? = nil, totalCount: Int? = nil, itemsPerPage: Int? = nil, statusCode: Int? = nil, logId: Int? = nil, success: Bool? = nil, message: String? = nil, validationErrors: [String: [String]]? = nil) {
