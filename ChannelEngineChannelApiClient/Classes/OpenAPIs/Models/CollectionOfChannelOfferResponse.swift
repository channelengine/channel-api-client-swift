...
public struct CollectionOfChannelOfferResponse: Codable, Hashable {
    ...
    public init(content: [ChannelOfferResponse]? = nil, count: Int? = nil, totalCount: Int? = nil, itemsPerPage: Int? = nil, statusCode: Int? = nil, logId: Int? = nil, success: Bool? = nil, message: String? = nil, validationErrors: [String: [String]]? = nil) {
