...
public struct CollectionOfChannelOfferResponse: Codable, Hashable {
    ...
    public init(content: [ChannelOfferResponse]? = nil, count: Int? = nil, totalCount: Int? = nil, itemsPerPage: Int? = nil, statusCode: Int? = nil, requestId: String? = nil, logId: String? = nil, success: Bool? = nil, message: String? = nil, validationErrors: [String: [String]]? = nil) {
