...
public struct CollectionOfChannelShipmentResponse: Codable {
    ...
    public init(content: [ChannelShipmentResponse]?, count: Int?, totalCount: Int?, itemsPerPage: Int?, statusCode: Int?, logId: Int?, success: Bool?, message: String?, validationErrors: [String:[String]]?) {
